  ...
  return (
    <>
      <div className="relative h-full w-full">
        ...
        >
          <span className="font-semibold text-sm text-[#e5e7eb] z-10">
            BASED IN ARGENTINA
          </span>
          ...
          <h2 className="text-stone-100 text-center px-8 z-10">
            <strong>Passionate game programmer</strong> experienced in{" "}
            <strong>Unity and C#</strong>. Skilled to{" "}
            <strong>develop data-oriented, high-performance solutions</strong>.{" "}
            <strong>Ambitious and constantly learning.</strong>
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
            ...
            <ButtonCustom
              ...
              url="/files/CV-FedericoBilotti.pdf"
            ></ButtonCustom>
          </div>
        </section>
      </div>
