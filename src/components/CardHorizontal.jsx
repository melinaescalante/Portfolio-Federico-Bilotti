export function CardHorizontal({ title, img, description, color }) {
    return (
        <div className="min-h-28 max-h-28 bg-[#1a1a1a] hover:bg-[#262626] hover:border-stone-600 hover:border border border-transparent transition-colors duration-300 w-full items-center rounded-lg flex px-4 py-3 gap-3">
